...
import io.github.adbhelper.common.compose.WaitingDialog
                    ...
                    ActionIconButton(
                        onClick = {
                            coroutineScope.launch(Dispatchers.IO) {
                                clipboard.setClipEntry(ClipEntry(StringSelection(desc!!.absolutePath))) // see: https://youtrack.jetbrains.com/issue/CMP-7624
